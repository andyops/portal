...
try {
    ...
    if (empty($nameExist)) {
        ...
        $insertStmt = $conn->prepare("INSERT INTO `tbl_user` (`user_id`, `first_name`, `last_name`, `contact_number`, `email`, `username`, `password`) VALUES (NULL, :first_name, :last_name, :contact_number, :email, :username, :password)");
